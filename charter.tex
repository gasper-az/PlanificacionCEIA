...
\pagebreak
    ...
    & Obtener métricas de \textit{F1-score} para \textit{XGBoost}, con \textit{feature engineering} & & & \\ \cline{2-2}
...
%=======================================================================================================================================%
    & Replicar técnicas de análisis de datos en entorno MLFlow & & & \\ \cline{2-2}
    & Replicar técnicas de entrenamiento de modelos de \textit{XGBoost} en entorno MLFlow & & & \\ \cline{2-2}
\multirow{-3}{=}[3em]{HU7 - Despliegue en MLFlow}
    & Replicar técnicas de evaluación de modelos en entorno MLFlow
    & \multirow{-3}{=}[3em]{Entorno MLFlow desplegado localmente}
    & \multirow{-3}{=}[3em]{Se puede acceder al entorno MLFlow de manera local}
